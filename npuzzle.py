...
class Tiles(State):
    ...
    def get_applicable_actions(self):
        ...
        for movement in Movement:
            ...
            if 0 <= new_empty_tile_row and new_empty_tile_row < self.width and 0 <= new_empty_tile_col and new_empty_tile_col < self.width:
    ...
    def get_action_result(self, movement):
        ...
        new_tiles[self.empty_tile_row * self.width + self.empty_tile_col] = self.get_tile(new_empty_tile_row, new_empty_tile_col)
...
def BFTS_demo():
    ...
    solution = BreadthFirstTreeSearch.find_solution(initial_configuration, goal_test)
